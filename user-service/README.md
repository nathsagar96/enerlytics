...
The **User Service** is a core microservice in the Enerlytics ecosystem, responsible for managing user profiles,
preferences, and alerting configurations. It provides a robust RESTful API to handle user-related operations and
integrates with the overall monitoring and alerting flow.
...
- **Database**: Isolated per test class (e.g., `users`)
